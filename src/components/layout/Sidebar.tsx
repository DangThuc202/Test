...
import { BookOpen, BookIcon, Users, CalendarIcon, LayoutDashboard, Settings, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    <div className="sidebar-wrapper">
      ...
      >
        <div className="flex items-center px-4 h-16 border-b border-sidebar-border">
          ...
          {collapsed && <BookIcon className="h-6 w-6 text-lms-blue-600 mx-auto" />}
        </div>
